      ...
      <main className="flex flex-1 flex-col items-center justify-center px-6 py-16">
        <div className="w-full max-w-[384px] space-y-8">
          ...
          <div className="flex flex-col space-y-4">
            <Button variant="outline" className="w-full h-10 font-medium bg-white border border-zinc-200 text-zinc-950 hover:bg-zinc-50 shadow-sm">
          ...
          <form action={formAction} className="space-y-6">
            <div className="space-y-4">
              <div className="flex gap-4">
                <div className="space-y-2 flex-1">
                  ...
                  <Input id="firstName" name="firstName" placeholder="Jordan" required className="h-10 rounded-lg bg-zinc-50 border border-zinc-200 focus-visible:ring-primary" />
                </div>
                <div className="space-y-2 flex-1">
                  <Label htmlFor="lastName" className="font-medium text-sm">Last name</Label>
                  <Input id="lastName" name="lastName" placeholder="Kim" required className="h-10 rounded-lg bg-zinc-50 border border-zinc-200 focus-visible:ring-primary" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="company" name="company" placeholder="Acme Corp" required className="h-10 rounded-lg bg-zinc-50 border border-zinc-200 focus-visible:ring-primary" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="password" className="font-medium text-sm">Password</Label>
                <Input id="password" name="password" type="password" placeholder="Min. 8 characters" required minLength={8} className="h-10 rounded-lg bg-zinc-50 border border-zinc-200 focus-visible:ring-primary" />
              </div>
            </div>
            ...
            <p className="text-center text-xs text-muted-foreground pt-1">
              ...
              <Link href="/terms" className="font-medium text-zinc-950 hover:underline">
                Terms of Service
              </Link>
              {' '}and{' '}
              <Link href="/privacy" className="font-medium text-zinc-950 hover:underline">
                Privacy Policy
              </Link>
              .
            </p>
