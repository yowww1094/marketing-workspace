              ...
              <form className="flex flex-col gap-5">
                <div className="grid grid-cols-2 gap-5">
                  <div className="flex flex-col gap-2">
                    ...
                    <input type="text" id="firstName" placeholder="Jane" className="h-11 px-4 rounded-lg border border-[#e2e2ea] text-[14px] focus:outline-none focus:border-[#5b5bd6] focus:ring-1 focus:ring-[#5b5bd6]" />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label htmlFor="lastName" className="text-[14px] font-medium text-[#0c0c0e]">Last name</label>
                    <input type="text" id="lastName" placeholder="Smith" className="h-11 px-4 rounded-lg border border-[#e2e2ea] text-[14px] focus:outline-none focus:border-[#5b5bd6] focus:ring-1 focus:ring-[#5b5bd6]" />
                  </div>
                </div>

                <div className="flex flex-col gap-2">
                  <label htmlFor="email" className="text-[14px] font-medium text-[#0c0c0e]">Email address</label>
                  <input type="email" id="email" placeholder="jane@example.com" className="h-11 px-4 rounded-lg border border-[#e2e2ea] text-[14px] focus:outline-none focus:border-[#5b5bd6] focus:ring-1 focus:ring-[#5b5bd6]" />
                </div>

                <div className="flex flex-col gap-2">
                  <label htmlFor="inquiryType" className="text-[14px] font-medium text-[#0c0c0e]">How can we help you?</label>
                  <select id="inquiryType" defaultValue="" className="h-11 px-4 rounded-lg border border-[#e2e2ea] text-[14px] text-[#0c0c0e] bg-white focus:outline-none focus:border-[#5b5bd6] focus:ring-1 focus:ring-[#5b5bd6] cursor-pointer">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea id="message" rows={4} placeholder="How can we help?" className="p-4 rounded-lg border border-[#e2e2ea] text-[14px] focus:outline-none focus:border-[#5b5bd6] focus:ring-1 focus:ring-[#5b5bd6] resize-none" />
                </div>

                <Button type="button" className="w-full h-12 bg-[#5b5bd6] hover:bg-[#4a4ac0] text-white rounded-lg mt-2 font-medium">
                  Send message
                </Button>
              </form>
            </div>
